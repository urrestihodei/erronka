...
public class jokalariaKudeatu {
	...
	private void fitxategiaSortu() {
		// Solicitar al usuario que ingrese el nombre del archivo (sin la extensión .sql)
     ...
     // Crear el objeto File con la ruta completa del archivo en el escritorio
        ...
        try {
         ...
         // Recorrer el ArrayList de jokalariak y escribir las sentencias SQL en el archivo
